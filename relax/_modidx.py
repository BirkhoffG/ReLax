  ...
  'syms': { 'relax.data.loader': { 'relax.data.loader.ArrayDataset': ('data.loader.html#arraydataset', 'relax/data/loader.py'),
            ...
            'relax.methods.vanilla': { 'relax.methods.vanilla.VanillaCF': ('methods/vanilla.html#vanillacf', 'relax/methods/vanilla.py'),
                                       ...
                                       'relax.methods.vanilla._vanilla_cf': ( 'methods/vanilla.html#_vanilla_cf',
                                                                              'relax/methods/vanilla.py')},
            'relax.ml_model': { 'relax.ml_model.BaseModule': ('ml_model.html#basemodule', 'relax/ml_model.py'),
                                'relax.ml_model.BaseModule.__init__': ('ml_model.html#basemodule.__init__', 'relax/ml_model.py'),
                                'relax.ml_model.BaseModule.name': ('ml_model.html#basemodule.name', 'relax/ml_model.py'),
                                'relax.ml_model.BaseModule.save': ('ml_model.html#basemodule.save', 'relax/ml_model.py'),
                                ...
                                'relax.ml_model.PredFnMixedin': ('ml_model.html#predfnmixedin', 'relax/ml_model.py'),
                                'relax.ml_model.PredFnMixedin.pred_fn': ('ml_model.html#predfnmixedin.pred_fn', 'relax/ml_model.py'),
                                'relax.ml_model.TrainableMixedin': ('ml_model.html#trainablemixedin', 'relax/ml_model.py'),
                                'relax.ml_model.TrainableMixedin.is_trained': ( 'ml_model.html#trainablemixedin.is_trained',
                                                                                'relax/ml_model.py'),
                                'relax.ml_model.TrainableMixedin.train': ('ml_model.html#trainablemixedin.train', 'relax/ml_model.py'),
