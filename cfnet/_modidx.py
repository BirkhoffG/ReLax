...
d = { 'settings': { 'branch': 'master',
  ...
  'syms': { 'cfnet.datasets': { 'cfnet.datasets.DataLoader': ('datasets.html#dataloader', 'cfnet/datasets.py'),
                                ...
                                'cfnet.datasets.TabularDataModule.val_dataloader': ( 'datasets.html#tabulardatamodule.val_dataloader',
                                                                                     'cfnet/datasets.py'),
                                'cfnet.datasets._data_name2configs': ('datasets.html#_data_name2configs', 'cfnet/datasets.py'),
                                'cfnet.datasets._download_data': ('datasets.html#_download_data', 'cfnet/datasets.py'),
