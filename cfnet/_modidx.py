...
d = { 'settings': { 'branch': 'master',
                ...
                'lib_path': 'cfnet'},
  'syms': { 'cfnet.datasets': { 'cfnet.datasets.DataLoader': ('datasets.html#dataloader', 'cfnet/datasets.py'),
                                'cfnet.datasets.DataLoader.__init__': ('datasets.html#dataloader.__init__', 'cfnet/datasets.py'),
                                'cfnet.datasets.DataLoader.__iter__': ('datasets.html#dataloader.__iter__', 'cfnet/datasets.py'),
                                'cfnet.datasets.DataLoader.__len__': ('datasets.html#dataloader.__len__', 'cfnet/datasets.py'),
                                'cfnet.datasets.DataLoader.__next__': ('datasets.html#dataloader.__next__', 'cfnet/datasets.py'),
                                ...
                                'cfnet.datasets.TabularDataModule.check_cols': ( 'datasets.html#tabulardatamodule.check_cols',
                                                                                 'cfnet/datasets.py'),
                                'cfnet.datasets.TabularDataModule.download_data': ( 'datasets.html#tabulardatamodule.download_data',
                                                                                    'cfnet/datasets.py'),
                                'cfnet.datasets.TabularDataModule.get_sample_X': ( 'datasets.html#tabulardatamodule.get_sample_x',
                                                                                   'cfnet/datasets.py'),
                                'cfnet.datasets.TabularDataModule.name_to_config': ( 'datasets.html#tabulardatamodule.name_to_config',
                                                                                     'cfnet/datasets.py'),
